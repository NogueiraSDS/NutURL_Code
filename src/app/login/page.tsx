    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, padding: '2rem' }}>
      <div className="glass" style={{ padding: '3rem', maxWidth: '400px', width: '100%', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: '1rem', fontWeight: 800 }}>
          Acesse sua <span className="text-gradient">Conta</span>
        </h1>
        <p style={{ color: '#94a3b8', marginBottom: '2rem' }}>
          Faça login para gerenciar seus links curtos e ver as métricas.
        </p>

        <button onClick={signInWithGoogle} className="btn" style={{ width: '100%', display: 'flex', gap: '0.5rem', justifyContent: 'center', alignItems: 'center' }}>
